...
var InterpolatedSignalCheck = class extends TemplateCheckWithVisitor {
  ...
  visitNode(ctx, component, node) {
    if (node instanceof Interpolation) {
      ...
      if ((node.type === BindingType.Property || node.type === BindingType.Class || node.type === BindingType.Style || node.type === BindingType.Attribute || node.type === BindingType.AnimationBinding || node.type === BindingType.LegacyAnimation) && nodeAst) {
 ...
 * found in the LICENSE file at https://angular.dev/license
 */
//# sourceMappingURL=chunk-EGLQSR42.js.map
