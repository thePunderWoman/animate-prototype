...
/**
 * Registers elements for delayed action for animation
 */
declare class ElementRegistry {
    private outElements;
    remove(el: Element): void;
    add(el: Element, animateFn: Function): void;
    has(el: Element): boolean;
    animate(el: Element, removeFn: Function): void;
    static ɵfac: __FactoryDeclaration<ElementRegistry, never>;
    static ɵprov: __InjectableDeclaration<ElementRegistry>;
}
