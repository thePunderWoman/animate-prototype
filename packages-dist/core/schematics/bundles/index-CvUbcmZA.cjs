...
var checker = require('./checker-DP_dEw82.cjs');
...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-e8e1a42'));
 ...
 */
new checker.Version('20.0.3+sha-e8e1a42');
    ...
    visitNode(ctx, component, node) {
        ...
        // bound properties like `[prop]="mySignal"`
            ...
            (node.type === checker.BindingType.Property ||
                ...
                // or an attribute binding like `[animation.in]="mySignal"`
                node.type === checker.BindingType.AnimationBinding ||
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-e8e1a42` usually means that core is at head so it supports
