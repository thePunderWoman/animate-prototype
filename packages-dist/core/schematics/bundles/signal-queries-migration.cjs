...
require('os');
var index$1 = require('./index-CvUbcmZA.cjs');
require('path');
var project_paths = require('./project_paths-BKvdR8jZ.cjs');
var apply_import_manager = require('./apply_import_manager-B0EZdijk.cjs');
var migrate_ts_type_references = require('./migrate_ts_type_references-DoQ3EXNN.cjs');
var assert = require('assert');
var index = require('./index-uTOoSCcV.cjs');
