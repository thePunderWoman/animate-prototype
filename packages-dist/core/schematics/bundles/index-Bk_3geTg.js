...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('19.2.9+sha-cb4c3da-with-local-changes'));
 ...
 */
new compiler.Version('19.2.9+sha-cb4c3da-with-local-changes');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.9+sha-cb4c3da-with-local-changes` usually means that core is at head so it supports
