...
import { platformBrowser, BrowserModule } from './browser-DZ-11qBI.mjs';
import './dom_renderer-CWIo6-S_.mjs';
...
class DOMTestComponentRenderer extends TestComponentRenderer {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.0.3+sha-e8e1a42", ngImport: i0, type: DOMTestComponentRenderer, deps: [{ token: DOCUMENT }], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.0.3+sha-e8e1a42", ngImport: i0, type: DOMTestComponentRenderer });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.3+sha-e8e1a42", ngImport: i0, type: DOMTestComponentRenderer, decorators: [{
            type: Injectable
...
class BrowserTestingModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.0.3+sha-e8e1a42", ngImport: i0, type: BrowserTestingModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.0.3+sha-e8e1a42", ngImport: i0, type: BrowserTestingModule, exports: [BrowserModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.0.3+sha-e8e1a42", ngImport: i0, type: BrowserTestingModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.3+sha-e8e1a42", ngImport: i0, type: BrowserTestingModule, decorators: [{
            type: NgModule,
            args: [{
